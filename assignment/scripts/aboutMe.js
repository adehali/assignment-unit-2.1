...
// let pets = 1; (Redeclaring)
//let friendsPets = 2;  (Redeclaring)
pets = 3;
...
result ? console.log('Adventures are great!') : console.log('How about we stay home?";');
